<div class="row">
  <div class="col-md-6">
    <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-9">
            {!! Form::select('status', $status, 2, ['class' => 'form-control select2']) !!}
    ...
    <div class="form-group{{ $errors->has('rjtl') ? ' has-error' : '' }}">
        {!! Form::label('rjtl', 'Jenis Layanan BPJS', ['class' => 'col-sm-3']) !!}
        <div class="col-sm-9">
            {!! Form::select('rjtl', ['2'=>'RJTL'], null, ['class' => 'form-control select2']) !!}
            <small class="text-danger">{{ $errors->first('rjtl') }}</small>
        </div>
    </div>
    <div class="form-group{{ $errors->has('kepesertaan') ? ' has-error' : '' }}">
        {!! Form::label('kepesertaan', 'Kepesertaan JKN', ['class' => 'col-sm-3']) !!}
        <div class="col-sm-9">
    ...
    <div class="form-group{{ $errors->has('hakkelas') ? ' has-error' : '' }}">
        {!! Form::label('hakkelas', 'Hak Kelas', ['class' => 'col-sm-3']) !!}
        <div class="col-sm-9">
    ...
    <div class="form-group{{ $errors->has('nomorrujukan') ? ' has-error' : '' }}">
        {!! Form::label('nomorrujukan', 'Nomor Rujukan', ['class' => 'col-sm-3']) !!}
        <div class="col-sm-9">
    ...
    <div class="form-group{{ $errors->has('tglrujukan') ? ' has-error' : '' }}">
        {!! Form::label('tglrujukan', 'Tanggal Rujukan', ['class' => 'col-sm-3']) !!}
        <div class="col-sm-9">
    ...
    <div class="form-group{{ $errors->has('kodeasal') ? ' has-error' : '' }}">
        {!! Form::label('kodeasal', 'Kode Asal Rujukan', ['class' => 'col-sm-3']) !!}
        <div class="col-sm-9">
  ...
  <div class="col-md-6">
    ...
    <div class="form-group{{ $errors->has('dokter_id') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-9">
            {!! Form::select('dokter_id', $dokter, null, ['class' => 'form-control select2']) !!}
    ...
    <div class="form-group{{ $errors->has('icd') ? ' has-error' : '' }}">
        {!! Form::label('icd', 'Diagnosa Awal', ['class' => 'col-sm-3']) !!}
        <div class="col-sm-9">
          <select class="form-control select2" name="icd">
    ...
    <div class="form-group{{ $errors->has('kecelakaan') ? ' has-error' : '' }}">
        {!! Form::label('kecelakaan', 'Kecelakaan', ['class' => 'col-sm-3']) !!}
        <div class="col-sm-9">
            {!! Form::select('kecelakaan', ['2'=>'TIDAK','1'=>'YA'],null, ['class' => 'form-control select2' ]) !!}
            <small class="text-danger">{{ $errors->first('kecelakaan') }}</small>
        </div>
    </div>
    <div class="form-group{{ $errors->has('jkn') ? ' has-error' : '' }}">
        {!! Form::label('jkn', 'JKN', ['class' => 'col-sm-3']) !!}
        <div class="col-sm-9">
    ...
    <div class="form-group{{ $errors->has('no_sep') ? ' has-error' : '' }}">
      {!! Form::label('no_sep', 'Nomor SEP', ['class' => 'col-sm-3']) !!}
      <div class="col-sm-9">
    ...
    <div class="form-group{{ $errors->has('sebabsakit_id') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-9">
            {!! Form::select('sebabsakit_id', $sebabsakit, null, ['class' => 'form-control select2']) !!}
    ...
    <div class="form-group{{ $errors->has('no_jkn') ? ' has-error' : '' }}">
        {!! Form::label('no_jkn', 'Nomor JKN', ['class' => 'col-sm-3']) !!}
        <div class="col-sm-9">
    ...
    <div class="form-group{{ $errors->has('status_ugd') ? ' has-error' : '' }}">
        {!! Form::label('status_ugd', 'Tingkat Kegawatan', ['class' => 'col-sm-3']) !!}
        <div class="col-sm-9">
            {!! Form::select('status_ugd', ['P1'=>'P1','P2'=>'P2','P3'=>'P3','P4'=>'P4'], null, ['class' => 'form-control select2']) !!}
