...
@section('content')
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title">
      Data Neraca&nbsp;
      </h3><a href="{{url('kasir/keuangan')}}" class="btn btn-success">Back</a><hr>
      <div class="col-md-12">
          <form method="post" action="{{url('/keuangan/neraca')}}">
          ...
          <table class='table table-striped table-bordered table-hover table-condensed text-center' id="data">
            ...
            @foreach($no_jurnal as $data)
              <tr>
                ...
                <td><a href="{{url('/keuangan/neraca/'.$data->no_jurnal)}}" class="btn btn-info btn-flat btn-sm" style="font-weight:bold;"><i class="fa fa-check"></i>&nbsp Detail</a></td>
              </tr>
              @endforeach
            </tbody>
