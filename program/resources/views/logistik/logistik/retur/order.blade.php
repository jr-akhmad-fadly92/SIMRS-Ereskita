    ...
    <div class="box box-primary">
		...
		<div class="box-body">
			<div class="row">
				<div class="col-md-6">
					@if(!isset($po_id))
						{!! Form::open(['method' => 'POST', 'url' => '/gudang/retur/order', 'class' => 'form-horizontal']) !!}				  
		...
		<div class="box box-primary">
			...
			<div class="box-body">
				<div class="">
					...
					<div class="col-sm-12 no-padding">
						<a href="{{ url('/gudang/retur-kirim-order/'.$po_id) }}" class="btn btn-success btn-flat pull-right" onclick="return confirm('Yakin transaksi diselesaikan?')">Kirim Retur</a>
					</div>
				</div>
			</div>
		</div>
...
$(document).on('click', '.hapus', function(e) {
	...
	if (confirm('Apakah yakin item ini akan dihapus?')) {
		$.ajax({
			url: '/gudang/retur-hapus-detail/' + id,
			type: 'GET',
			success: function (data) {
				console.log(data);
				if(data.sukses == true) {
