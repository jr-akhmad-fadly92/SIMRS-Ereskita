  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <!--div class="form-group" id="kelompokkelas_idGroup">
          {!! Form::label('kelompokkelas_id', 'Kelompok', ['class' => 'col-sm-3']) !!}
          <div class="col-sm-9">
      ...
      <div class="form-group" id="kelas_idGroup">
          {!! Form::label('kelas_id', 'Kelas', ['class' => 'col-sm-3']) !!}
          <div class="col-sm-9">
      ...
      <div class="form-group" id="kamaridGroup">
          {!! Form::label('kamarid', 'Kamar', ['class' => 'col-sm-3']) !!}
          <div class="col-sm-9">
      ...
      <div class="form-group " id="bedID">
          {!! Form::label('bed_id', 'Bed', ['class' => 'col-sm-3']) !!}
          <div class="col-sm-9">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group{{ $errors->has('no_tlp') ? ' has-error' : '' }}">
								...
								<div class="col-sm-8">
										{!! Form::text('no_tlp', '', ['class' => 'form-control', 'readonly' => 'true']) !!}
						...
						<div class="form-group{{ $errors->has('no_rujukan') ? ' has-error' : '' }}">
								...
								<div class="col-sm-8">
										{!! Form::text('no_rujukan', config('app.sep_ppkLayanan'), ['class' => 'form-control', 'readonly'=>true]) !!}
