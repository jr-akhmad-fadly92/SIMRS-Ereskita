		...
		<div class="col-md-8">
			...
			<div class="media-video" id="media-video">
				...
				<div id="judul" class="text-center">
					...
					<iframe autoplay="true" id="video-live" width="560" height="315" src="https://www.youtube.com/embed/FEJsoBM4Guk?&autoplay=1" allow="autoplay" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>
