...
@extends('master')
@section('header')
  <h1>Distribus Order Non-Medis</h1-->
@endsection
...
@section('script')
    ...
    $('.tableData').DataTable({
          ...
          processing: true,
          serverSide: true,
          ajax: '/gudang/dist-nonmedis/po-data',
          columns: [
              {data: 'rownum'},
              {data: 'no_po'},
              {data: 'tanggal'},
    ...
    $(document).on('click', '.view',function () {
        ...
        $.ajax({
            url: 'dist-nonmedis/po-data-detail/'+id,
            type: 'GET',
		...
		var table = $('#dataDetailPO').DataTable({
			  ...
			  info        : false,
			  serverSide  : true,
			  ajax: '/gudang/dist-nonmedis/list-po-data/'+id,
			  columns: [
				  {data: 'rownum'},
				  {data: 'kode_barang'},
				  {data: 'nama_barang'},
				  {data: 'jumlah'},
				  {data: 'kode_barang_pemberian'},
				  {data: 'nama_barang_pemberian'},
