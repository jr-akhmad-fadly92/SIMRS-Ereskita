...
Route::get('/guest/layarantrian-polic', 'GuestController@layarantrianPolic');
...
Route::group(['middleware'=>['web','auth']], function () {
  ...
  include __DIR__ .'/simrs/surat.php';
  include __DIR__ .'/simrs/keuangan.php';
  include __DIR__ .'/simrs/alergi.php';
  // folder logistik =================================================
