...
<div id="content">
  <div style="text-align:center;"><b><u>Pernyataan Internal Inventaris</u></b><br>
  Unit Rawat Jalan
  </div>

   <p>Kepada Yth.<br>
   Kepala Inventaris RS {{$config->nama}}<br>
   Di Tempat</p><br>
   <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Dengan hormat,<br>
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Dengan ini saya atas nama Kepala Logistik {{$config->nama}} menginformasikan untuk barang inventaris unit Rawat Jalan yaitu :</p>
...
@endforeach
    ...
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Selanjutnya pihak kepala unit Rawat Jalan bertanggung jawab atas inventaris tersebut di atas serta sanggup untuk mengganti inventaris yang hilang tersebut</p>
    ...
    <table width="100%">
      ...
      <tr>
        ...
        <td width="33%" style="text-align: center;">Mengetahui,<br>Kepala Inventaris RS</td>
