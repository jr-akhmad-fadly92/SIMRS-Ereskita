...
<div class="form-group{{ $errors->has('aktiva') ? ' has-error' : '' }}">

    {!! Form::label('aktiva', 'Tipe aktiva', ['class' => 'col-sm-3 control-label']) !!}

    <div class="col-sm-9">

        {!! Form::select('aktiva', ['netral'=>'netral', 'tetap'=>'Tetap', 'lancar'=>'Lancar'], null, ['class' => 'form-control']) !!}

        <small class="text-danger">{{ $errors->first('aktiva') }}</small>
...
<div class="btn-group pull-right">
    ...
    <a href="{{ url('keuangan/akun') }}" class="btn btn-warning btn-flat">Batal</a>
