...
<html>
  <head>
    ...
    <style media="screen">
		...
		@if($regs->status_reg == 'G1')
			<META HTTP-EQUIV="REFRESH" CONTENT="0; URL={{ url('frontoffice/rawat-darurat') }}">	
		@else
			<META HTTP-EQUIV="REFRESH" CONTENT="0; URL={{ url('antrian/daftarantrian/'.session('no_loket')) }}">
		@endif
  <head>
