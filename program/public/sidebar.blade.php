...
<section class="sidebar">
	...
	<ul class="sidebar-menu" data-widget="tree" style="margin-top:10px;padding-right:5px;">
		...
		@endrole
		@role(['admission','fisioterapi','gizi','apotik', 'supervisor-apotik','rawatjalan', 'rawatinap','rawatdarurat','laboratorium','operasi','radiologi','kamarbersalin','gizi','rekammedis','administrator'])
			@include('sidebar/inv')
		@endrole
