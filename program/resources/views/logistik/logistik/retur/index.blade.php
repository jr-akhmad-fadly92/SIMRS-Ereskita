...
@section('content')
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">
            Data Retur Obat ke Supplier &nbsp; &nbsp;    <a href="{{ url('/gudang/retur/order') }}" class="btn btn-success btn-sm btn-flat">Retur</a>
        </h3>
      </div>
      <div class="box-body">
