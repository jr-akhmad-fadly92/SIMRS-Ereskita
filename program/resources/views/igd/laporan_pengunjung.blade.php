@extends('master')
@section('header')
  <h1>Rawat Darurat - Laporan Pengunjung<small></small></h1>
@endsection
    ...
    <div class="box-body">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            <label for="tanggal" class="col-md-3">Nama Kota</label>
            <div class="col-md-8">
          ...
          <div class="form-group">
            <label for="tanggal" class="col-md-3">Petugas Registrasi</label>
            <div class="col-md-8">
              <select class="form-control" name="user_create">
                <option value="">[Semua]</option>
                @foreach (Modules\Pegawai\Entities\Pegawai::where('kategori_pegawai',7)->get() as $key => $d)
