	...
	<ul class="treeview-menu">
		...
		<li class="treeview {{ Auth::user()->role()->first()->name!='administrator' ? 'active' : '' }}">
			...
			<ul class="treeview-menu">
				...
				<li><a href="{{ url('/kontrolpanel/sif') }}"><i class="fa fa-circle-o"></i> <span>Sif</span></a></li>
				<li><a href="{{ url('/kontrolpanel/sif_online') }}"><i class="fa fa-circle-o"></i> <span>User Online</span></a></li>
			</ul>
		</li>
		<li class="treeview {{ Auth::user()->role()->first()->name!='administrator' ? 'active' : '' }}">
			<a href="#">
			...
			<ul class="treeview-menu">
				...
				<li><a href="{{ url('/mastermapping') }}"><i class="fa fa-circle-o"></i> <span>Asuransi</span></a></li>
			</ul>
		</li>
		<li class="treeview {{ Auth::user()->role()->first()->name!='administrator' ? 'active' : '' }}">
			<a href="#">
