...
@section('content')
	<div class="col-md-2 no-padding" style="padding-right:10px!important;">	
		<h4 style="margin-top:0;font-size:14px;font-weight:600;">
			Rawat {{$layanan}} - Order Laboratorium
		</h4>
				...
				<div class="tab-pane active" id="tab_tindakan">
					<div class="row">
						<div style="padding:0 10px;">
							...
							<div class="box-info" style="margin-bottom:10px;">
									...
									@php
										...
										if($layanan=='Jalan'){
											...
											$layanan_tipe = 'rajal_lab';
										}elseif($layanan=='Darurat'){
											$link_tipe = 'darurat';
											$layanan_tipe = 'darurat_lab';
										}elseif($layanan=='Inap'){
											$link_tipe = 'rawat-inap';
											$layanan_tipe = 'ranap_lab';
										}
									@endphp
										...
										<div class="col-md-12">
												...
												<div class="form-group{{ $errors->has('tarif_id') ? ' has-error' : '' }}">
													...
													<div class="col-md-12">
														<select class="form-control select2" name="tarif_id">
															...
															@foreach(Modules\Tarif\Entities\Tarif::where('kategoritarif_id', 2)->get() as $d)
											...
											<div class="col-md-3 no-padding">
												<div class="form-group">
													...
													<div class="col-md-12">
														{!! Form::submit("Tambah Tindakan", ['style'=>'margin-left:10px;margin-top:2px;', 'class' => 'btn btn-success btn-flat', 'onclick'=>'javascript:return confirm("Yakin Data Ini Sudah Benar")']) !!}
													</div>
												</div>
											</div>
										</div>
								...
								<div>
									<table class='table table-striped table-bordered table-hover table-condensed'>
										<thead>
											...
											<th>Waktu</th>
											<th>Bayar</th>
											@role(['supervisor', 'laboratorium','administrator','rawatjalan','rawatdarurat','rawatinap'])
											<th>Hapus</th>
											@endrole
											</tr>
										</thead>
											...
											<tr>
												...
												@role(['supervisor', 'laboratorium','administrator','rawatjalan','rawatdarurat','rawatinap'])
													...
													@if ($d->lunas == 'Y')
														<i class="fa fa-check"></i>
													@else
														<a href="{{ url('laboratorium/hapus-tindakan/'.$d->id.'/'.$d->registrasi_id.'/'.$d->pasien_id.'/'.$link_tipe) }}" onclick="return confirm('Yakin akan di hapus?')" class="btn btn-danger btn-sm btn-flat"><i class="fa fa-trash-o"></i></a>
													@endif
													</td>
												@endrole
											</tr>
							...
							@if(count($folio)>0)
								<div class="col-md-12">
								{!! Form::open(['method' => 'POST', 'url' => 'tindakan/simpan-laboratorium', 'class' => 'form-horizontal']) !!}
									...
									<div class="btn-group pull-right">
											{!! Form::submit("ORDER LAB", ['class' => 'btn btn-success btn-flat']) !!}
									</div>
								{!! Form::close() !!}
								</div>
							@endif
