...
<title>Laporan Stok Gudang Obat</title>
<style>
    @page {
      size: auto;
...
<body>
    <htmlpageheader name="MyHeader1">
        <div style="text-align: right; border-bottom: 1px solid #000000; font-weight: bold; font-size: 10pt;">Laporan Stok Gudang Obat</div>
    </htmlpageheader>
