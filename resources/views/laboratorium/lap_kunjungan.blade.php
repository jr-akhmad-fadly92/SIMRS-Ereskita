      ...
      {!! Form::open(['method' => 'POST', 'url' => '/laboratorium/laporan-kunjungan', 'class' => 'form-horizontal']) !!}
        ...
        <div class="col-md-3">
          <div class="input-group{{ $errors->has('politipe') ? ' has-error' : '' }}">
              ...
              <select class="form-control" name="pasien_asal">
                  
                  <option value="TA" selected>Rawat Jalan</option>
        ...
        <div class="col-md-3">
          <div class="btn-group">
            <input type="submit" name="view" class="btn btn-primary btn-flat fa fa-file" value=" &#xf1c2; VIEW">
            {{--<input type="submit" name="excel" class="btn btn-success btn-flat fa fa-file-excel-o" value=" &#xf1c3; EXCEL">--}}
            <input type="submit" target="_blank" name="pdf" class="btn btn-danger btn-flat fa fa-file-pdf-o" value="&#xf1c1; CETAK">
          </div>
        </div>
        </div>
        <br>
        <div class="row">
        <div class="col-md-3">
          <div class="input-group{{ $errors->has('dokter_id') ? ' has-error' : '' }}">
              <span class="input-group-btn">
                ...
                <select class="form-control" name="dokter_id">
                  <option value="">[Semua]</option>
                    @foreach (Modules\Pegawai\Entities\Pegawai::where('kategori_pegawai', 1)->get() as $key => $d)
