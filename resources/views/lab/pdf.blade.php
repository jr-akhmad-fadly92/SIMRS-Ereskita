...
<html lang="en">
  ...
  <body onload="print()" style="padding-top:0px;font-size:11px;">
    <div style="width: 5%; float:left">
      <img src="{{ asset('images/'.configrs()->logo) }}" class="img img-responsive" style="height:50px;width:auto;">
    </div>
    <div>
		...
		<table style="width: 100%">
			<tbody>
				...
				<tr>
					<td style="width:33%;"></td>
					<td style="width:33%;"></td>
					<td style="width:33%;height:100px;text-align:center;">{{ Auth::user()->name }}</td>
				</tr>
			</tbody>
		</table>
  </body>
