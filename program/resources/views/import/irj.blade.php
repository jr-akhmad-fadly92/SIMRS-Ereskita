        ...
        <div class="col-md-8">
          ...
          {!! Form::open(['method' => 'POST', 'route' => 'import-irj', 'class' => 'form-horizontal','files'=>true]) !!}
            ...
            <div class="form-group{{ $errors->has('kategoriheader') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    {!! Form::select('kategoriheader', Modules\Kategoriheader\Entities\Kategoriheader::pluck('nama', 'id'), 1, ['class' => 'chosen-select']) !!}
            ...
            <div class="form-group{{ $errors->has('kategoritarif_i') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    {!! Form::select('kategoritarif_id', Modules\Kategoritarif\Entities\Kategoritarif::pluck('namatarif', 'id'), 1, ['class' => 'chosen-select']) !!}
